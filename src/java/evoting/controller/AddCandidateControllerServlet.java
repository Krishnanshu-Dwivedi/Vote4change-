...
public class AddCandidateControllerServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String req_type =(String)request.getParameter("id");
        String usid = (String)request.getParameter("uid");
        if(req_type != null && req_type.equalsIgnoreCase("getid")){
            try
            {
        ...
        else if(usid != null)
        {
            try {
                ...
                ex.printStackTrace();
                RequestDispatcher rd = request.getRequestDispatcher("showexcepton.jsp");
                request.setAttribute("Exception", ex);
                rd.forward(request, response);
            }
        }
