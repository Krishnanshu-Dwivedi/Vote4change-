    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            if(data != null && data.equalsIgnoreCase("uid")){
               ArrayList<String> userList = UserDAO.getUsers();
                request.setAttribute("userid", userList);   
                request.setAttribute("result", "uid_list");
               
            }   
            else{
                ArrayList<UserDetails> ud = UserDAO.getDetailsById();
